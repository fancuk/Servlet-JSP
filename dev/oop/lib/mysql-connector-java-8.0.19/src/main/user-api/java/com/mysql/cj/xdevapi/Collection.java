...
public interface Collection extends DatabaseObject {
     ...
     *
     * @param doc map of key-value parameters representing the document fields
     ...
     *
     * @param jsonStrings one or more documents given as JSON strings
     * @return {@link AddStatement}
     */
     ...
     *
     * @param documents one or more documents given as {@link DbDoc}
     * @return {@link AddStatement}
     */
     ...
     * @param doc the new document, which may contain expressions. If document contains an _id value, it is ignored.
     ...
     *
     * @param id         the document id of the document to be replaced
     * @param jsonString the new document, given as JSON string, which may contain expressions. If document contains an _id value, it is ignored.
     * @return Result object, which will indicate the number of affected documents (1 or 0, if none)
     */
     ...
     *
     * @param id  the document id of the document to be replaced
     * @param doc the new document, which may contain expressions. If doc contains an _id value and it does not match the given id then the error
     *            will be thrown.
     * @return Result object, which will indicate the number of affected documents (0 - if none, 1 - if added, 2 - if replaced)
     */
     ...
     *
     * @param id         the document id of the document to be replaced
     * @param jsonString the new document, given as JSON string, which may contain expressions. If doc contains an _id value and it does not match the given id then
     ...
     *
     * @param id the document id of the document to be retrieved
     * @return the document, or NULL if no match found
     */
     ...
     * @return Returns a Result object, which will indicate the number of removed documents (1 or 0, if none)
     */
