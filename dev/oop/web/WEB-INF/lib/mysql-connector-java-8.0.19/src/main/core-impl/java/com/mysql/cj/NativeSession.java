...
public class NativeSession extends CoreSession implements Serializable {
     ...
     *
     * @param dontCheckServerMatch if true then send the SET NAMES query even if server charset already matches the new value
     ...
     * older than 4.1.0
     * @throws CJException if an exception happens while sending 'SET NAMES' to the
