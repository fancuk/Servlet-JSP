...
public interface JdbcConnection extends java.sql.Connection, MysqlConnection, TransactionEventHandler {
     ...
     *
     * @param sql             statement
     * @param autoGenKeyIndex autoGenKeyIndex
     * @return prepared statement
     * @throws SQLException if an error occurs
     ...
     *
     * @param sql               statement
     * @param autoGenKeyIndexes autoGenKeyIndexes
     * @return prepared statement
     * @throws SQLException if an error occurs
     * @see java.sql.Connection#prepareStatement(String, int[])
     */
     ...
     *
     * @param sql                statement
     * @param autoGenKeyColNames autoGenKeyColNames
     * @return prepared statement
     * @throws SQLException if an error occurs
    ...
    /**
     * @param flag The failedOver flag to set.
     */
     ...
     * @param skipLocalTeardown if true, driver tries to close connection normally, performing rollbacks,
     *                          closing open statements etc; otherwise the force close is performed
     * @param reason            the exception caused this method call
     * @throws SQLException if an error occurs
     */
     ...
     *
     * @param dbName the database for this connection to use
     * @throws SQLException if a database access error occurs
     */
