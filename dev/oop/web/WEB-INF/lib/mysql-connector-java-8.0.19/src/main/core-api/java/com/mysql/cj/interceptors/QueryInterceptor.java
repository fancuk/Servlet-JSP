...
public interface QueryInterceptor {
     ...
     *
     * @param sql              the Supplier for SQL representation of the query
     * @param interceptedQuery the actual {@link Query} instance being intercepted
     * @param <T>              {@link Resultset} object
     ...
     * it will only be called from one thread at a time.
     *
     * @param queryPacket original {@link Message}
     * @param <M>         {@link Message} object
     ...
     * @param sql               the Supplier for SQL representation of the query
     * @param interceptedQuery  the actual {@link Query} instance being intercepted
     * @param originalResultSet a {@link Resultset} created from query execution
     ...
     * it will only be called from one thread at a time.
     *
     * @param queryPacket            query {@link Message}
