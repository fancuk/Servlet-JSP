...
public class ClientFactory {
     ...
     * @param clientPropsJson JSON string representing a document that defines connection properties in a special format.
     ...
     *
     * @param url         the session URL.
     * @param clientProps the {@link Properties} instance that contains the connection properties. The keys in this {@link Properties} match with the path of each value
